<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="unumber" label="学号"></el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small" :rules="rules"  ref="dataForm" :model="form">
        ...
        <el-form-item label="学号" prop="uNumber" v-if="form.role == 'ROLE_USER'">
          <el-input v-model="form.unumber" autocomplete="off"></el-input>
        </el-form-item>
  ...
  methods: {
    load() {
      ...
      this.request.get("/user/page", {
        ...
        // alert("用户信息:"+JSON.stringify(res.data));

      })

      //权限获取
      this.request.get("/role").then(res => {
        // console.log("打印权限"+res.data)
        this.roles = res.data
      })

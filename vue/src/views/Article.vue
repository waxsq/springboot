<template>
    <div>
        <div style="margin: 10px 0">
            ...
            <el-input style="width: 200px" placeholder="请输入发布时间" suffix-icon="el-icon-search" v-model="publishtime"></el-input>
        ...
        <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
            ...
            <el-table-column prop="publishtime" label="发布时间" sortable></el-table-column>
